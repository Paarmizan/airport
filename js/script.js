...
let chooseFirst = document.querySelector('.choose__item_first');
let chooseSecond = document.querySelector('.choose__item_second');
let chooseThird = document.querySelector('.choose__item_third');
let chooseTitle = document.querySelector('.choose__title');
let chooseThanks = document.querySelector('.choose__thanks');

console.log(chooseThird);
...
document.addEventListener('click', event => {
	...
	switch(event.target) {
		...
		case chooseFirst:
			alert('Вы выбрали МС-1');
			toNone();
			chooseThanks.classList.add('_active');
			break;
		case chooseSecond:
			alert('Вы выбрали SSJ');
			toNone();
			chooseThanks.classList.add('_active');
			break;
		case chooseThird:
			alert('Вы выбрали Ил-114');
			toNone();
			chooseThanks.classList.add('_active');
			break;
...
function toNone() {
	chooseFirst.style = 'display: none';
	chooseSecond.style = 'display: none';
	chooseThird.style = 'display: none';
